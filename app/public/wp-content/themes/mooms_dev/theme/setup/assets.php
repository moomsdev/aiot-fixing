...
function app_action_theme_enqueue_assets()
{
    ...
    wp_localize_script('theme-js-bundle', 'themeData', [
        ...
        'i18n' => [
            'already_sent_title' => __('You have already sent a request', 'gaumap'),
            'already_sent_text' => __('You have sent a contact within the last 24 hours. Please try again later.', 'gaumap'),
            'success_title' => __('Sent successfully', 'gaumap'),
            'success_text_default' => __('Thank you for contacting us.', 'gaumap'),
            'error_title' => __('Unable to send', 'gaumap'),
